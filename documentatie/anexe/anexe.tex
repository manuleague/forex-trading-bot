...
\newpage
\section{Checklist de verificare a cerințelor din ghid}
\label{anexa:checklist_ghid}

Tabelul următor sintetizează modul în care documentația respectă structura recomandată pentru proiectul de diplomă.

\begin{table}[H]
    \centering
    \caption{Acoperirea cerințelor de structură}
    \label{tabel:anexa_checklist_ghid}
    \begin{tabular}{|p{5.2cm}|p{3cm}|p{5cm}|}
        \hline
        \textbf{Cerință} & \textbf{Status} & \textbf{Unde este acoperită} \\
        \hline
        Rezumat 150--250 cuvinte și cuvinte-cheie & Îndeplinit & Rezumat \\
        \hline
        Introducere cu context, obiective și metodologie & Îndeplinit & Capitolul 1 \\
        \hline
        Fundamentare teoretică și soluții similare & Îndeplinit & Capitolul 2 \\
        \hline
        Cerințe, arhitectură și implementare & Îndeplinit & Capitolul 3 \\
        \hline
        Algoritmi, pseudocod și formule & Îndeplinit & Capitolul 3 și Anexe \\
        \hline
        Testare, configurare, metrici și rezultate & Îndeplinit & Capitolul 4 \\
        \hline
        Fiabilitate, securitate și scalabilitate & Îndeplinit & Capitolul 4 \\
        \hline
        Concluzii și direcții viitoare & Îndeplinit & Capitolul 5 \\
        \hline
        Bibliografie IEEE & Îndeplinit & Bibliografie \\
        \hline
        Anexe cu comenzi, parametri și cod relevant & Îndeplinit & Anexe \\
        \hline
    \end{tabular}
\end{table}

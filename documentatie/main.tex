...
%% Pentru portabilitate pe MiKTeX/Overleaf fara -shell-escape, codul este randat cu listings.
%% Pastrez un environment compatibil cu sintaxa \begin{minted}{python} folosita in template.
\usepackage{newfloat}
\definecolor{codeKeyword}{RGB}{0,112,32}
\definecolor{codeString}{RGB}{163,21,21}
\definecolor{codeComment}{RGB}{92,99,112}
\definecolor{codeIdentifier}{RGB}{30,41,59}
\DeclareFloatingEnvironment[
    fileext=lol,
    listname={Listă de coduri},
    name=Cod
]{listing}
\lstnewenvironment{minted}[2][]{
    \lstset{
        language=#2,
        basicstyle=\small\ttfamily\bfseries\color{codeIdentifier},
...
%% ==================================================================================================== %%
%% Pachetele demo din template au fost dezactivate pentru forma de lucru/finala.
%% \usepackage{lipsum}
...
%% \clearpage este folosit pentru a evita paginile goale mari in varianta digitala a lucrarii.
    \pagestyle{empty}
    {
        %% coperta externa
    ...
    %% dupa fiecare capitol, in main.tex este introdus \clearpage pentru separare fara pagini goale.
    ...
    \input{continut/capitol5/capitol5}
    \clearpage

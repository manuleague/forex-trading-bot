...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{5.2cm}|p{8.4cm}|}
        ...
        \hline
        \texttt{dashboard.html} & Demonstrează modul în care rezultatele pot fi inspectate vizual după rulare. \\
        \hline
        \texttt{performance\_dashboard.svg} & Poate fi inclus ca imagine pentru evoluția performanței și a capitalului. \\
        \hline
        \texttt{trades.csv} & Poate fi deschis în Excel pentru a arăta tranzacțiile generate și motivele de intrare/ieșire. \\
        \hline
        \texttt{risk\_overlay\_metrics.csv} & Demonstrează trasabilitatea deciziilor de risc și motivele respingerii semnalelor. \\
        \hline
        Captură Grafana pentru EURUSD/GBPUSD/USDJPY & Demonstrează observabilitatea live, separarea dashboard-urilor pe paritate și funcționarea Prometheus. \\
        \hline
        Captură Prometheus Targets & Demonstrează că endpoint-ul \texttt{host.docker.internal:18000} este colectat cu starea \texttt{UP}. \\
        \hline
    \end{tabular}
\end{table}

...
\begin{itemize}
    ...
    \item monitorizarea live trebuie să ofere vizibilitate asupra prețurilor, semnalelor, pozițiilor și performanței curente.
\end{itemize}

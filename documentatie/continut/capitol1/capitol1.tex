...
\begin{itemize}
    ...
    \item conectarea controlată la un broker în regim paper trading, pentru verificarea comportamentului live fără expunere financiară reală;
    \item expunerea de metrici operaționale pentru monitorizarea comportamentului live.
\end{itemize}

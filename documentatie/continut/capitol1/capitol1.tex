...
Tema acestei lucrări constă în proiectarea și implementarea unui sistem software pentru automatizarea și evaluarea strategiilor de tranzacționare pe piața Forex. Proiectul analizat este disponibil într-un depozit GitHub \cite{misc:web:forex_quant_bot_repo} și poartă denumirea \textit{Forex Quant Bot}. Aplicația este dezvoltată în Python și are două direcții principale de utilizare: rularea de teste istorice deterministe, pe date stocate local, și testarea operațională în regim \textit{paper trading} prin Interactive Brokers. Separarea acestor două moduri de funcționare este importantă, deoarece permite validarea logicii de tranzacționare într-un mediu controlat înainte de orice formă de utilizare live.
